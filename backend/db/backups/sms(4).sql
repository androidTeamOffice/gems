...
CREATE TABLE `course` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `for_cadre` varchar(50) DEFAULT NULL,
...
ALTER TABLE `course_completion`
  ...
  ADD CONSTRAINT `course_completion_ibfk_4` FOREIGN KEY (`cadre_id`) REFERENCES `trades` (`id`),
  ADD CONSTRAINT `fk_cadre_id` FOREIGN KEY (`cadre_id`) REFERENCES `cadres` (`id`),
  ADD CONSTRAINT `fk_cadre_id1` FOREIGN KEY (`cadre_id`) REFERENCES `cadres` (`id`);
