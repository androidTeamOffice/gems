        ...
        <TableContainer sx={{ boxShadow: "none" }}>
          <Table>
            ...
            <TableBody>
              ...
              <PagesBodyCell
                rows={["2. /pages/argon-dashboard", 520, "00:23:13", "31.14%"]}
              />
              <PagesBodyCell
                rows={["3. /pages/argon-dashboard", 122, "00:3:10", "54.10%"]}
              />
              <PagesBodyCell
                rows={["4. /bootstrap-themes", "1,900", "00:30:42", "20.93%"]}
              />
              <PagesBodyCell
                rows={["5. /react-themes", "1,442", "00:31:50", "34.98%"]}
              />
              <PagesBodyCell
                rows={[
